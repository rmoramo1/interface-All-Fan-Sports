                ...
                <div className="col-12 bg-dark h-100">
                    <div className="row g-0">
                        ...
                        <div className="col-3 text-center">
                            <Link className="btn btn-dark text-white" to={`/edtihGolf/${props.id}`}><i className="far fa-eye"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
...
ListGolfEvents.propTypes = {
    id: PropTypes.number,
    casino: PropTypes.string,
    date: PropTypes.string,
    event: PropTypes.string,
};
export default ListGolfEvents;
