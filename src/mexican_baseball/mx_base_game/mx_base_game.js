...
export const MX_Base_Game = () => {
    ...
    //
    const [awayCrear, setAwayCrear] = useState("Mariachis de Guadalajara");
    const [pitcher_a, setPitcher_a] = useState("");
    const [HomeCrear, setHomeCrear] = useState("Mariachis de Guadalajara");
    ...
    let actualizar = () => {
        document.getElementById("miFormMxBas").reset();
    }
    const crear = e => {
        actualizar();
        e.preventDefault();
        ...
        fetch("https://sportsdata365.com/baseball_mexico", {
            method: "POST",
    ...
    return (
        <div className="container-fluid p-0 m-0 accordion" id="gameCreate_MLB" >
            <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                <h3>Create Maxican Baseball Game</h3>
            </div>
            <form onSubmit={crear} id="miFormMxBas">
