...
export const Team_MX_BASE_Stas = () => {
    ...
    let actualizar = () => {
        document.getElementById("miForm_team_mx_stats").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_baseball_mexico_team", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create stats by MX BASEBALL Team</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miForm_team_mx_stats">
                <div className="row g-0">
