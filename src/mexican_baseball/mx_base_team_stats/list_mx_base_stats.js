...
import { Stat_Single_MX_BASE } from "./stat_single_mx_base";

export const List_MX_BASE_Stats = () => {
    ...
    var sortStats = store.stats_baseball_mexico_team;
                ...
                <div className="col-12 p-3 bg-title-edith my-2 d-flex justify-content-center align-items-center">
                    <div className="row g-0 w-100">
                        <div className="col-12">
                            <h4 className="fw-bold text-center">MX BASEBALL STATS BY TEAM</h4>
                        </div>
                    </div>
                </div>
                {
