...
import { Single_PY_MX_BASE_Stats } from "./single_py_mx_base_stats";
export const List_Stats_MX_BASE_PY = () => {
    ...
    var sortStats_py = store.stats_mexico_baseball_player;
        ...
        <div className="container-fluid m-50">
            <div className="row g-0">
                ...
                <div className="row g-0 w-100">
                        <div className="col-8">
                            <h4 className="fw-bold text-center">MX BASEBALL PLAYER STATS </h4>
                        </div>
                        <div className="col-4">
