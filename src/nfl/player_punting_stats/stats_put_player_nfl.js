...
export const Stats_put_player_nfl = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormNFL_put_PY").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_punting_player_nfl", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats Punting Player of NFL</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miFormNFL_put_PY">
                <div className="row g-0">
