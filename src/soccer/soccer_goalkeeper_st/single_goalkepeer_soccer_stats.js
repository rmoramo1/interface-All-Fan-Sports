...
export const Single_py_goalkeeper_stats = props => {
    return (
                ...
                <div className="col-1 py-1">
                    <div className="col-12 bg-dark h-100 d-flex justify-content-center align-items-center ">
                        <div className="col-12 text-center">
                            <Link className="text-white" to={`/edit_stats_goalkeeper_soccer/${props.id}`}><i className="far fa-eye"></i></Link>
                        </div>
                    </div>
                </div>
...
Single_py_goalkeeper_stats.propTypes = {
    id: PropTypes.number,
