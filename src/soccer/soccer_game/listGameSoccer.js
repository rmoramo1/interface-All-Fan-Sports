            ...
            <div className="col-1 d-flex justify-content-center align-items-center py-3">
                <div className="col-12 bg-dark h-100">
                    ...
                    <div className="col-12 text-center">
                        <Link className="btn btn-dark text-white" to={`/edtihGame_Soccer/${props.id}`}><i className="far fa-eye"></i></Link>
                    </div>
                </div>
            </div>
            <div className="col-11 bg-white my-3 shadow">
                <div className="row g-0 text-center title-lines">
                    <div className="col-1 lines" id="statusSoccer">{props.status}</div>
                    <div className="col-2 lines">RT# / Team</div>
                    <div className="col-1 lines">GL</div>
                ...
                <div className="">
                    <div className="row g-0 text-center">
                        ...
                        <div className="col-1 lines">{props.goal_line_away}</div>
                        <div className="col-1 lines">{props.juice_goal_away}</div>
                    ...
                    <div className="row g-0 text-center">
                        ...
                        <div className="col-1 lines">{props.goal_line_home}</div>
                        <div className="col-1 lines">{props.juice_goal_home}</div>
