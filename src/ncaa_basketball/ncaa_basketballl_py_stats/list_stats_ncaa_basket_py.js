...
import { Single_py_ncaa_basket_stats } from "./single_py_ncaa_basket_stats";
export const List_Stats_Ncaa_basket_PY = () => {
    ...
    var sortStats_py = store.ncaa_basket_stats_player;
        ...
        <div className="container-fluid m-50">
            <div className="row g-0">
                ...
                <div className="row g-0 w-100">
                        <div className="col-8">
                            <h4 className="fw-bold text-center">NCAA BASKETBALL PLAYER STATS </h4>
                        </div>
                        <div className="col-4">
