...
import { Stat_Single_NCAA_BASKETBALL } from "./stat_single_ncaa_basket";

export const List_NCAA_BASKETBALL_Stats = () => {
    ...
    var sortStats = store.ncaa_basket_team_player;
