...
export const Edtih_Moto_GP = (props) => {
    ...
    const [place2, setplace2] = useState(store.moto_gp[params.theid] && store.moto_gp[params.theid].place2);
    const [place3, setplace3] = useState(store.moto_gp[params.theid] && store.moto_gp[params.theid].place3);
            ...
            <form onSubmit={crear}>
                <div className="row g-0">
                    <div className="col-2 text-center p-1">
                        Status
                        <select className="form-select" name="status" aria-label="Default select example" defaultValue={store.moto_gp[params.theid] && store.moto_gp[params.theid].status} onChange={e => setStatusCrear(e.target.value)} required>
                            {
                    ...
                    <div id="crear-juego" className="">
                        <div>
                            ...
                            <div className="row g-0">
                                ...
                                <div className="col-1">
                                    <input type="text" className="form-control selectInner" placeholder="Track" name="Track" defaultValue={store.moto_gp[params.theid] && store.moto_gp[params.theid].track} onChange={e => settrack(e.target.value)} />
                                </div>
                                <div className="col-1">
                                    <input type="text" className="form-control selectInner" placeholder="Location" name="location" defaultValue={store.moto_gp[params.theid] && store.moto_gp[params.theid].location} onChange={e => setlocation(e.target.value)} />
                                </div>
                                <div className="col-2">
                                    <input className="form-control selectInner" type="text" placeholder="Place 1" aria-label="default input example" defaultValue={store.moto_gp[params.theid] && store.moto_gp[params.theid].place1} onChange={e => setplace1(e.target.value)} />
                                </div>
                                <div className="col-1">
                                    <input className="form-control selectInner" type="text" placeholder="Place 2" aria-label="default input example" defaultValue={store.moto_gp[params.theid] && store.moto_gp[params.theid].place2} onChange={e => setplace2(e.target.value)} />
                                </div>
                                <div className="col-2">
                                    <input className="form-control selectInner" type="text" placeholder="Place 3" aria-label="default input example" defaultValue={store.moto_gp[params.theid] && store.moto_gp[params.theid].place3} onChange={e => setplace3(e.target.value)} />
                                </div>
                            </div>
                        </div>
                    </div>
