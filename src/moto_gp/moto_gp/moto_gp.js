...
export const Moto_GP = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormMotoGp").reset();
    }
    const crear = e => {
        actualizar()
        e.preventDefault();
        ...
        fetch("https://sportsdata365.com/moto_gp", {
            method: "POST",
    ...
    return (
        <div className="container-fluid p-0 m-0 accordion" id="gameCreate" >
            <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                <h3>Create Moto GP Race</h3>
            </div>
            <form onSubmit={crear} id="miFormMotoGp" >
