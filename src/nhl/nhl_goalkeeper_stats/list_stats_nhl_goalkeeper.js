...
import { Single_Goalkeeper_nhl_stats } from "./single_goalkeeper_nhl_stats";
export const List_Stats_NHL_Goalkeeper = () => {
    ...
    var sortStats_py = store.nhl_stats_goalkeeper;
