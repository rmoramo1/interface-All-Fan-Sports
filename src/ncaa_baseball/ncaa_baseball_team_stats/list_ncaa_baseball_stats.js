...
import { Stat_Single_NCAA_BASEBALL } from "./stat_single_ncaa_baseball";

export const List_NCAA_BASEBALL_Stats = () => {
    ...
    var sortStats = store.ncaa_baseball_stats_team;
