...
export const Stats_put_player_ncaa_foot = () => {
    ...
    let actualizar = () => {
        document.getElementById("miForm_ncaa_put_PY").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_punting_player_ncaa_football", {
            method: "POST",
    ...
    return (
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            ...
            <form onSubmit={crear} id="miForm_ncaa_put_PY">
                <div className="row g-0">
