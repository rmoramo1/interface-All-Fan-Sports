...
import List_Game_Ncaa_Football from "./listGameNcaa_football";
import { Context } from "../../store/appContext";

export const CreateGames_Ncaa_Football = () => {
	...
	let teamFilter = store.ncaa_football;
	...
	return (
		<div className="container-fluid">
			<div className="col-12 bg-title-edith my-2 p-3 text-center">
				<h3>List of NCAA Football Games</h3>
			</div>
