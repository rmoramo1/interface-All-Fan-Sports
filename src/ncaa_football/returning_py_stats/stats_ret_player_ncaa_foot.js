...
export const Stats_ret_player_ncaa_foot = () => {
    ...
    let actualizar = () => {
        document.getElementById("miForm_ncaa_ret_PY").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_returning_player_ncaa_football", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats Returning Player of NCAA</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miForm_ncaa_ret_PY">
                <div className="row g-0">
