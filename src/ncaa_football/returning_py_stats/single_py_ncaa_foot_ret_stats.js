...
export const Single_PY_NCAA_FOOT_RET_STATS = props => {
    return (
                ...
                <div className="col-1 py-1">
                    <div className="col-12 bg-dark h-100 d-flex justify-content-center align-items-center ">
                        <div className="col-12 text-center">
                            <Link className="text-white" to={`/edit_stats_ret_player_nca_foot/${props.id}`}><i className="far fa-eye"></i></Link>
                        </div>
                    </div>
                </div>
...
Single_PY_NCAA_FOOT_RET_STATS.propTypes = {
    id: PropTypes.number,
