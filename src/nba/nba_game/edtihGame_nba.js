...
export const EdithGames_nba = (props) => {
    ...
    const [week, setWeekCrear] = useState(store.nbaGames[params.theid].week);
    const [date, setdate] = useState(store.nbaGames[params.theid].date);
    const [hour, sethour] = useState(store.nbaGames[params.theid].hour);
        ...
        <div className="container-fluid accordion" id="gameEdith" >
            ...
            <form onSubmit={crear}>
                <div className="row g-0">
                    ...
                    <div className="text-center col-1 p-1">
                        Week
                        <select className="form-select" name="week" aria-label="Default select example" defaultValue={store.nbaGames[params.theid].week} onChange={e => setWeekCrear(e.target.value)} required>
                            {
