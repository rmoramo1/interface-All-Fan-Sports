...
import { Single_py_wnba_stats } from "./single_py_wnba_stats";
export const List_Stats_WNBA_PY = () => {
    ...
    var sortStats_py = store.wnba_stats_player;
        ...
        <div className="container-fluid m-50">
            <div className="row g-0">
                ...
                <div className="row g-0 w-100">
                        <div className="col-8">
                            <h4 className="fw-bold text-center">WNBA PLAYER STATS </h4>
                        </div>
                        <div className="col-4">
