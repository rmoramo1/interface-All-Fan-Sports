...
export const Stats_py_wnba = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormWNBA_stats_player").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_wnba_player", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats WNBA Player</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miFormWNBA_stats_player">
                <div className="row g-0">
