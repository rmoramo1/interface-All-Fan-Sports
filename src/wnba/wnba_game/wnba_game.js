...
export const WNBA_game = () => {
    ...
    //away
    const [awayCrear, setAwayCrear] = useState("Atlanta Dream");
    ...
    //home
    const [HomeCrear, setHomeCrear] = useState("Atlanta Dream");
    ...
    let actualizar = () => {
        document.getElementById("miFormWNBA").reset();
    }
    const crear = e => {
        actualizar();
        e.preventDefault();
        ...
        fetch("https://sportsdata365.com/wnba", {
            method: "POST",
    ...
    return (
        <div className="container-fluid p-0 m-0 accordion" id="gameCreate" >
            <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                <h3>Create WNBA Game</h3>
            </div>
            <form onSubmit={crear} id="miFormWNBA">
