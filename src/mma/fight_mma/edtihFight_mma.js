...
export const EdithFight_mma = (props) => {
    ...
    const [week, setWeek] = useState(store.mma_fight[params.theid].week);
    ...
    const crear = e => {
        ...
        fetch("https://interfaceroy.herokuapp.com/mma/" + store.mma_fight[params.theid].id, {
            method: "PUT",
            ...
            <form onSubmit={crear}>
                <div className="row g-0">
                    <div className="col-2 text-center">
                        Status
                        <select className="form-select" name="status" aria-label="Default select example" defaultValue={store.mma_fight[params.theid].status} onChange={e => setStatusCrear(e.target.value)}>
                            {
                    ...
                    <div className="col-3">
                        ...
                        <select className="form-select" name="casino" aria-label="Default select example" defaultValue={store.mma_fight[params.theid].casino} onChange={e => setcasino(e.target.value)}>
                            {
