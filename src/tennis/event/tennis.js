...
export const Tennis = () => {
    ...
    const [hour_matchup_1, sethour_matchup_1] = useState("");
    const [hour_matchup_2, sethour_matchup_2] = useState("");
    const [hour_matchup_3, sethour_matchup_3] = useState("");
    const [hour_matchup_4, sethour_matchup_4] = useState("");
    const [hour_matchup_5, sethour_matchup_5] = useState("");
    const [hour_matchup_6, sethour_matchup_6] = useState("");
    const [hour_matchup_7, sethour_matchup_7] = useState("");
    const [hour_matchup_8, sethour_matchup_8] = useState("");
    const [hour_matchup_9, sethour_matchup_9] = useState("");
    const [hour_matchup_10, sethour_matchup_10] = useState("");
    const [hour_matchup_11, sethour_matchup_11] = useState("");
    const [hour_matchup_12, sethour_matchup_12] = useState("");
    const [hour_matchup_13, sethour_matchup_13] = useState("");
    const [hour_matchup_14, sethour_matchup_14] = useState("");
    const [hour_matchup_15, sethour_matchup_15] = useState("");
    const [hour_matchup_16, sethour_matchup_16] = useState("");
    const [hour_matchup_17, sethour_matchup_17] = useState("");
    const [hour_matchup_18, sethour_matchup_18] = useState("");
    const [hour_matchup_19, sethour_matchup_19] = useState("");
    const [hour_matchup_20, sethour_matchup_20] = useState("");
    const [hour_matchup_21, sethour_matchup_21] = useState("");
    const [hour_matchup_22, sethour_matchup_22] = useState("");
    const [hour_matchup_23, sethour_matchup_23] = useState("");
    const [hour_matchup_24, sethour_matchup_24] = useState("");
    const [hour_matchup_25, sethour_matchup_25] = useState("");
    ...
    const crear = e => {
        ...
        fetch("https://sportsdata365.com/tennis", {
            method: "POST",
                    ...
                    <div id="crear-juego" className="row g-0">
                        <div className="col-12">
                            <div className="row g-0 text-center pt-3 ">
                                ...
                                <div className="col-5 title-lines">Tennis PY</div>
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_1(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_2(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_3(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_4(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_5(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_6(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_7(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_8(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_9(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_10(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_11(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_12(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_13(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_14(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_15(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_16(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_17(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_18(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_19(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_20(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_21(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_22(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_23(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_24(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_25(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_26(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_27(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_28(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_29(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_30(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_31(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_32(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_33(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_34(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_35(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_36(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_37(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_38(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_39(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_40(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_41(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_42(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_43(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_44(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_45(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_46(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_47(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_48(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                            ...
                            <div className="col-12">
                                <div className="row g-0">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_49(e.target.value)} />
                                    </div>
                                    <div className="col-2">
                                ...
                                <div className="row g-0 bb3px">
                                    ...
                                    <div className="col-5
                                ">
                                        <input type="text" className="form-control selectInner" placeholder="Golfer" name="rotation" onChange={e => setcompetitor_50(e.target.value)} />
                                    </div>
                                    <div className="col-2">
