...
export const Stats_put_player_canadian_foot = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormCana_put_PY").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_punting_player_canadian_football", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats Punting Player of Canadian Footaball</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miFormCana_put_PY">
                <div className="row g-0">
