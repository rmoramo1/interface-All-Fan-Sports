...
export const Team_Canadian_Foot_Standings = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormsTANDING_canadian").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/standing_canadian_football_team", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stadings by Canadian Football Team</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miFormsTANDING_canadian">
                <div className="row g-0">
