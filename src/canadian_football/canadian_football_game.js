...
export const Canadian_football = () => {
    ...
    //away
    const [awayCrear, setAwayCrear] = useState("Winnipeg");
    ...
    //home
    const [HomeCrear, setHomeCrear] = useState("Winnipeg");
    ...
    let actualizar = () => {
        document.getElementById("miFormCanna_foot").reset();
    }
    ...
    const crear = e => {
        ...
        fetch("https://sportsdata365.com/canadian_football", {
            method: "POST",
    ...
    return (
        <div className="container-fluid p-0 m-0 accordion" id="gameCreate" >
            <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                <h3>Create Canadian Football Game</h3>
            </div>
            <form onSubmit={crear} id="miFormCanna_foot">
