...
import List_Game_Cannadian_Fottbal from "./listGame_canadian_football";
import { Context } from "../store/appContext";

export const CreateGames_Cannadian_Foot = () => {
	...
	let teamFilter = store.canadian_football;
	...
	return (
		<div className="container-fluid">
			<div className="col-12 bg-title-edith my-2 p-3 text-center">
				<h3>List of Cannadian Football Games</h3>
			</div>
