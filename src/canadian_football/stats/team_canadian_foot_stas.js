...
export const Team_Canadian_Foot_Stas = () => {
    ...
    const crear = e => {
        ...
        fetch("https://sportsdata365.com/stats_canadian_football_team", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats by Canadian Football Team</h3>
                </div>
            </div>
            <form onSubmit={crear}>
                <div className="row g-0">
