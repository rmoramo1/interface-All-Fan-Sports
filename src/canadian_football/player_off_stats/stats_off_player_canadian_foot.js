...
export const Stats_Off_Player_Canadian_Foot = () => {
    ...
    const [long_pass, setlong_pass] = useState("");
    ...
    const [rush_td, setRush_td] = useState("");
    ...
    const [r_fum, setr_fum] = useState("");

    const [r_fl, setR_fl] = useState("");
    const [r_yac, setr_Yac] = useState("");
    const [r_fd, setR_fd] = useState("");
    const [pts, setPts] = useState("");

    const [auth, setAuth] = useState(false);
    let actualizar = () => {
        document.getElementById("miFormCanadian_off_PY").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_offensive_player_canadian_football", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats Offensive Player of Canadian Football</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miFormCanadian_off_PY">
                <div className="row g-0">
                ...
                <div className="mt-3">
                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="ATT" aria-label="default input example" onChange={e => setpass_att(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="CMP %" aria-label="default input example" onChange={e => setcmp_AVG(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="YDS" aria-label="default input example" onChange={e => setyards(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="AVG" aria-label="default input example" onChange={e => setyards_AVG(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="YDS S/G" aria-label="default input example" onChange={e => setyards_pg(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="LNG" aria-label="default input example" onChange={e => setlong_pass(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="TD" aria-label="default input example" onChange={e => setpass_td(e.target.value)} required />
                        </div>
                        <div className="col-1">
                        ...
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="SACK" aria-label="default input example" onChange={e => setsack(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="SYL" aria-label="default input example" onChange={e => setSyl(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="RTG" aria-label="default input example" onChange={e => setRtg(e.target.value)} required />
                        </div>
                    </div>
                </div>
                <div className="mt-3">
                    ...
                    <div className="row g-0">
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="ATT" aria-label="default input example" onChange={e => setRuss_att(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="YDS" aria-label="default input example" onChange={e => setRuss_yards(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="AVG" aria-label="default input example" onChange={e => setyards_p_russ(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="LNG" aria-label="default input example" onChange={e => setLr(e.target.value)} required />
                        </div>
                        <div className="col-1">
                        ...
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="TD" aria-label="default input example" onChange={e => setRush_td(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="YD S/G" aria-label="default input example" onChange={e => setRush_yard_pg(e.target.value)} required />
                        </div>
                        <div className="col-1">
                ...
                <div className="mt-3">
                    ...
                    <div className="row g-0">
                        ...
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="TGTS" aria-label="default input example" onChange={e => setR_Tgts(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="YDS" aria-label="default input example" onChange={e => setR_yards(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="AVG" aria-label="default input example" onChange={e => setyards_p_r(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="TD" aria-label="default input example" onChange={e => setR_td(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="BIG" aria-label="default input example" onChange={e => setR_big(e.target.value)} required />
                        </div>
                        <div className="col-1">
                        ...
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="FUM" aria-label="default input example" onChange={e => setr_fum(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="LST" aria-label="default input example" onChange={e => setR_fl(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="YAC" aria-label="default input example" onChange={e => setr_Yac(e.target.value)} required />
                        </div>
                        <div className="col-1">
                            <input className="form-control selectInner" type="text" placeholder="FD" aria-label="default input example" onChange={e => setR_fd(e.target.value)} required />
                        </div>
                    </div>
                </div>
                <div className="mt-3">
