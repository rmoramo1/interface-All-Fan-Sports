...
export const Stats_kik_player_canadian_foot = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormNFL_kik_PY").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/stats_kiking_player_canadian_football", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats Kicking Player of Canadian Football</h3>
                </div>
            </div>
            <form onSubmit={crear} id="miFormNFL_kik_PY">
                <div className="row g-0">
