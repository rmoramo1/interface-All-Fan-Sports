...
export const Stats_ret_player_canadian_foot = () => {
    ...
    const crear = e => {
        ...
        fetch("https://sportsdata365.com/stats_returning_player_canadian_football", {
            method: "POST",
        ...
        <div className="container-fluid p-0 m-0 accordion" id="statsCreate" >
            <div className="row g-0">
                <div className="col-12 bg-title-edith mt-2 p-3 text-center">
                    <h3>Create Stats Returning Player of Canadian Football</h3>
                </div>
            </div>
