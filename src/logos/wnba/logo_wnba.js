...
export const Logo_wnba = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormLogo_WNBA").reset();
    }
    const crear = e => {
        e.preventDefault();
        const body = {
        ...
        fetch("https://sportsdata365.com/logos_wnba", {
            method: "POST",
    ...
    return (
        <div className="row g-0 rounded overflow-hidden shadow">
            <form onSubmit={crear} id="miFormLogo_WNBA">
                <div className="col-12 title-lines text-center">
                    Create WNBA Team Logo
                </div>
