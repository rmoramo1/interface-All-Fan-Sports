...
export const Logo_Ncaa_basket = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormNcaa_logo_basket").reset();
    }
    const crear = e => {
        actualizar();
        e.preventDefault();
        ...
        fetch("https://sportsdata365.com/logos_ncaa_basketball", {
            method: "POST",
    ...
    return (
        <div className="row g-0 rounded overflow-hidden shadow">
            <form onSubmit={crear} id="miFormNcaa_logo_basket">
                <div className="col-12 title-lines text-center">
                    Create NCAA BASKETBALL Team Logo
                </div>
