...
import { Link } from "react-router-dom";
 ...
 const Vista_Logo_Canadian_Football = props => {
    return (
                ...
                <div className="col-1 py-1">
                    <div className="col-12 bg-dark h-100 d-flex justify-content-center align-items-center ">
                        <div className="col-12 text-center">
                            <Link className="text-white" to={`/edith_logo_canadian_logo/${props.id}`}><i className="far fa-eye"></i></Link>
                        </div>
                    </div>
                </div>
...
Vista_Logo_Canadian_Football.propTypes = {
    id: PropTypes.number,
    team: PropTypes.string,
    url: PropTypes.string,
};
export default Vista_Logo_Canadian_Football;