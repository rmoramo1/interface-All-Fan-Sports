...
export const Logo_Ncaa_Baseball = () => {
    ...
    let actualizar = () => {
        document.getElementById("miFormNcaa_logo_ncaa_baseball").reset();
    }
    const crear = e => {
        actualizar();
        e.preventDefault();
        ...
        fetch("https://sportsdata365.com/logos_ncaa_baseball", {
            method: "POST",
    ...
    return (
        <div className="row g-0 rounded overflow-hidden shadow">
            <form onSubmit={crear} id="miFormNcaa_logo_ncaa_baseball">
                <div className="col-12 title-lines text-center">
                    Create NCAA BASEBALL Team Logo
                </div>
