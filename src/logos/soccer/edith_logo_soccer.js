...
export const Edith_Logo_soccer = (props) => {
    ...
    const [team, setteam] = useState(store.logos_soccer[params.theid].team);
    const [url, seturl] = useState(store.logos_soccer[params.theid].url);
    ...
    const edit = e => {
        ...
        fetch("https://sportsdata365.com/logos_soccer/" + store.logos_soccer[params.theid].id, {
            method: "PUT",
            ...
            <div className="col-12 p-3 bg-title-edith my-2 d-flex justify-content-center align-items-center">
                <div className="row g-0 w-100">
                    ...
                    <div className="col-2 tetx-center">
                        <h4>
                            {store.logos_soccer[params.theid].team}
                        </h4>
                    </div>
                    <div className="col-1">
                        <img src={store.logos_soccer[params.theid].url} alt="logo team" className="img_logo"></img>
                    </div>
                </div>
            </div>
            <div className="row g-0 rounded overflow-hidden shadow">
                <form onSubmit={edit}>
                    ...
                    <div className="col-12">
                        <input type="text" className="form-control selectInner" placeholder="TEAM" name="rotation_home" defaultValue={store.logos_soccer[params.theid].team} onChange={e => setteam(e.target.value)} required />
                    </div>
                    <div className="col-12">
                        <input type="text" className="form-control selectInner" placeholder="URL" name="rotation_home" defaultValue={store.logos_soccer[params.theid].url} onChange={e => seturl(e.target.value)} required />
                    </div>
